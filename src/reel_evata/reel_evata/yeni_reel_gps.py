...
class RealGPSNavigator(Node):
    def __init__(self):
        ...
        # 1. DURAK (bekleme yok)
         ...
         # 1. durağın biraz ilerisi (20 sn bekle)   
            {
                'x': -52.098,
                'y': 27.985,
                'ox': 0.0,
          ...
          # 2. DURAK (bekleme yok) 
            {
                ...
                'ox': 0.0,
                'oy': 0.0,
                'oz': 0.00356549244557905,
                'ow': 0.9999936436116085,
                'wait': 0.0
            },
           # 2. durağın biraz ilerisi (20 sn bekle)
    ...
    def load_rejoin_points(self):
        ...
        filename = os.path.expanduser("~/ros2_ws/src/evata_real/config/rejoin_waypoints.txt")
